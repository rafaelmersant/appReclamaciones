    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="3">
                ...
                <table cellpadding="1" cellspacing="0" width="100%" style="border-right: #ccccff thin outset; border-top: #ccccff thin outset; border-left: #ccccff thin outset; border-bottom: #ccccff thin outset">
                    ...
                    <tr>
                        <td valign="middle">
                            <asp:Label ID="Label18" runat="server" CssClass="LetraH1" Font-Bold="True" Font-Names="Verdana"
                                Text="Motivo" Width="80px" Font-Size="12px"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtTipoPedido" runat="server" Height="11px" TabIndex="1" Width="288px" CssClass="LetraH2" ReadOnly="True"></asp:TextBox></td>
                        <td style="border-left: #ccccff thin outset; width: 10%;" valign="middle">
                    ...
                    <tr>
                        <td valign="middle">
                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="Verdana"
                                Text="Nombre Cliente" CssClass="LetraH1" Font-Size="12px"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td valign="middle">
                            <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Verdana"
                                Text="Contacto" Width="80px" CssClass="LetraH1" Font-Size="12px"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td valign="middle">
                            <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Names="Verdana"
                                Text="Soporte Venta" CssClass="LetraH1" Font-Size="12px"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td valign="middle">
                            <asp:Label ID="Label10" runat="server" CssClass="LetraH1" Font-Bold="True" Font-Names="Verdana"
                                Text="Factura" Visible="False" Width="80px" Font-Size="12px"></asp:Label></td>
                        <td>
                ...
                <asp:Label ID="Label23" runat="server" BackColor="SteelBlue" CssClass="headerSimples"
                    ...
                    Width="100%"></asp:Label><br />
                            ...
                            <asp:Label ID="Label22" runat="server" CssClass="LetraH1" Font-Bold="True" Font-Names="Verdana"
                                Text="Correo Cliente" Font-Size="12px"></asp:Label></td><td><asp:TextBox ID="txtCorreo" runat="server" CssClass="LetraH2"
                                TabIndex="1" Width="358px"></asp:TextBox></td><td>
                    <asp:Button ID="btnSaveMail" runat="server" BackColor="LightSteelBlue" BorderColor="LightSlateGray"
                                    ...
                                    Text="Guardar" Visible="False" /></td></tr></table>
        ...
        <tr>            
           <td colspan="3">                   
                ...
                <table style="width: 80%" cellpadding="0" cellspacing="0" >
                    <tr>
                    <td style="width:20%"><asp:Label id="Label15" runat="server" CssClass="listItems" Font-Bold="True" Text="Usuarios"></asp:Label></td>
                    <td style="width:5%"></td>
                    <td style="width:20%"><asp:Label id="Label17" runat="server" CssClass="listItems" Font-Bold="True" Text="Usuarios a Involucrar"></asp:Label></td>
                    <td style="width:5%"></td>
                    <td style="width:20%"><asp:Label id="Label13" runat="server" CssClass="listItems" Font-Bold="True" Text="Usuarios Involucrados"></asp:Label></td>
                ...
                </asp:UpdatePanel><asp:Button ID="btnInvolucrar" runat="server" Text="Involucrar" BackColor="SteelBlue" BorderColor="Gray" BorderStyle="Ridge" BorderWidth="1px" Font-Bold="True" Font-Names="Arial" ForeColor="White" Width="96px" Visible="False" />
        ...
        <tr>
            <td colspan="3" valign="top">
                ...
                <asp:Button ID="btnGDescrp" runat="server" Text="Guardar Descripción" BackColor="SteelBlue" BorderColor="Gray" BorderStyle="Ridge" BorderWidth="1px" Font-Bold="True" Font-Names="Arial" ForeColor="White" Width="155px" Visible="False" /></tr>        
        <tr>
            <td colspan="3">                                
        ...
        <tr>
            <td colspan="3">
                ...
                <Panes>
                    ...
                    <cc1:AccordionPane ID="AccordionPane6" runat="server" EnableViewState="true">                    
                    <Header> MARKETING </Header>
                    <Content>
             <asp:Panel ID="panelMarketing" runat="server" EnableViewState="true" Width="100%">
                    <table width="100%">
                        <tr>
                            <td align="left">
                                <asp:DataList ID="dlMarketing" runat="server" Width="100%">
                                    <ItemTemplate>
                        ...
                        <tr>
                            <td>
                                <asp:Panel ID="pnComentarioM" runat="server" EnableViewState="true" Width="100%">
                                    <asp:TextBox ID="txtComentarioM" runat="server" EnableViewState="true" Height="46px"
                                        TextMode="MultiLine" Visible="false" Width="99%"></asp:TextBox>
                                    <asp:Button ID="btnGuardaM" runat="server" BackColor="SteelBlue" BorderColor="Gray"
                                        BorderStyle="Ridge" BorderWidth="1px" Font-Bold="True" Font-Names="Arial" ForeColor="White"
                                        Text="Guardar" Visible="false" Width="86px" />
                                    <asp:Button ID="btnCancelarM" runat="server" BackColor="SteelBlue" BorderColor="Gray"
                                        BorderStyle="Ridge" BorderWidth="1px" Font-Bold="True" Font-Names="Arial" ForeColor="White"
                                        OnClick="btnCancelarM_Click" Text="Cancelar" Visible="false" Width="86px" />
                                </asp:Panel>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                                <asp:Button ID="btnAgregarM" runat="server" OnClick="btnAgregarM_Click" Text=" + "
                                    Visible="false" />
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                                <asp:FileUpload ID="fuFileM" runat="server" CssClass="LetraFiles" Visible="False"
                                    Width="522px" />
                                <asp:Button ID="btnAgregarFileM" runat="server" BackColor="SteelBlue" BorderColor="Gray"
                                    BorderStyle="Ridge" BorderWidth="1px" Font-Bold="True" Font-Names="Arial" ForeColor="White"
                                    Height="20px" Text="Agregar" Visible="False" Width="72px" />
                                    
                                    <br />
                                <asp:Literal ID="LiteralFileM" runat="server" Visible="False"></asp:Literal>
                                <asp:Button ID="btnEliminarAdjM" runat="server" BackColor="SteelBlue" BorderColor="Gray"
                                    BorderStyle="Ridge" BorderWidth="1px" Font-Bold="True" Font-Names="Arial" ForeColor="White"
        ...
        <tr>
            <td colspan="3" valign="top">
                ...
                <asp:TextBox ID="txtConclusion" runat="server" Height="60px" TextMode="MultiLine" Width="99%" ReadOnly="True" CssClass="headerSimples" ForeColor="Navy"></asp:TextBox></asp:Panel>
