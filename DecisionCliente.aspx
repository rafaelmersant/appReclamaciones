<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="DecisionCliente.aspx.vb" Inherits="Motivos" title="Reclamaciones" %>
        ...
        <tr>
            <td>
                <asp:Panel ID="Panel1" runat="server" BorderColor="SteelBlue" BorderWidth="1px" DefaultButton="btnGuardar"
                    Height="118px" Width="351px">
                    <table style="width: 100%">
                        <tr>
                            <td align="left" colspan="2" style="background-color: gray">
                                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Italic="True" Text=".::Decisiones del Cliente::." ForeColor="White"></asp:Label></td>
                        </tr>
                        <tr>
                            <td align="right">
                        ...
                        <tr>
                            <td align="right">
                                <asp:Label ID="Label1" runat="server" CssClass="letraUsual" Font-Bold="True" Text="Decisión"></asp:Label></td>
                            <td align="left">
        ...
        <tr>
            <td>
                <asp:GridView ID="grdMotivos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        <asp:BoundField HeaderText="Decisión" DataField="descripcion">
